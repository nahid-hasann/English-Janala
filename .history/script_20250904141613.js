...
const displaylessons = (lessons) => {
    ...
    lessons.forEach(lesson => {
        ...
        btndiv.innerHTML = `
           ...
           <div>
                 <button id="lession-btn" onclick="loadLevelword(${lesson.level_no})" class="btn btn-outline btn-primary"> <i class="fa-solid fa-book"></i> lession - ${lesson.level_no} </button>
            </div>
