...
const displaylessons = (lessons) => {
    ...
    lessons.forEach(lesson => {
        ...
        btndiv.innerHTML = `
                 ...
                 <button id="lession-btn-${lesson.level_no}"  onclick="loadLevelword(${lesson.level_no})" class="btn btn-outline btn-primary"> <i class="fa-solid fa-book"></i> lession - ${lesson.level_no} </button>
